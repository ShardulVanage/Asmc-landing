  ...
  return (
    <section className="bg-black py-28 md:py-40 px-6 overflow-hidden">
      <div className="max-w-6xl mx-auto" ref={ref}>
        ...
        >
          <span className="italic text-white/40">Innovation</span> x <span className="italic text-white/40">Vision</span>
        </motion.h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          ...
          <motion.div
            ...
            animate={isInView ? { opacity: 1, x: 0 } : { opacity: 0, x: 40 }}
            transition={{ duration: 0.9, delay: 0.1 }}
            className="flex flex-col justify-between gap-8 md:gap-12"
          >
            {/* Block 1 */}
            <div>
